...
We hope that you did read and mastered the [01_prerequisites_knowledge](../01_prerequisites_knowledge/README.md), the knowledge you gained from that chapter will be very helpful for you to understand the concepts and practices we will be using in our projects.
